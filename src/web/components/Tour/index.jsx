  ...
  renderStep_0() {
    return (
      <div>
        ...
        <p className={style.big}>Congratulations on choosing BlessedBot for your next bot!</p>
        <p>
          BlessedBot is the most effective way for developers to create a bot. This very short tour will help you get
          started quickly.
        </p>
        <hr />
        <p>
          First, you should know that a BlessedBot bot is just a regular Node.js application. There is no black magic,
          and everything your bot does is done either through code you write or done for you by pre-made modules (thanks
    ...
    return (
      <div>
        ...
        <p>
          ...
          to an existing module to add that feature. BlessedBot relies heavily on the community to thrive. Every single
    ...
    return (
      <div>
        ...
        <ul className={style.left}>
          <li>We recommend you setup the config files for production environments</li>
          <li>
            Do <strong>not</strong> store keys, passwords or any sensitive information in your botfile. Use environment
            variables instead.
          </li>
          <li>
            Switch to the <b>BlessedBot License</b> (the default license is AGPL), which is 100% free for all bots and
  ...
  render() {
    ...
    return (
      <Modal show={!this.state.finished && this.props.opened} onHide={this.handleClose} backdrop="static">
        <Modal.Header>
          <Modal.Title>Welcome on BlessedBot!</Modal.Title>
        </Modal.Header>
